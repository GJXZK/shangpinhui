        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(choose,index) in skuInfo.skuSaleAttrValueList" :key="index">
                <dt class="title">选择{{choose.saleAttrName}}</dt>
                <dd class="active">{{choose.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input type="number" autocomplete="off" class="itxt" v-model="skuNum" @change="changeSkuNum">
