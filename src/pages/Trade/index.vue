  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="good in userTrade.detailArrayList"
          :key="good.skuId"
        >
          <li>
    ...
    <div class="trade">
      <div class="price">
        应付金额:　<span>¥{{ userTrade.totalAmount }}</span>
      </div>
      <div class="receiveInfo">
        寄送至:
        <span>{{ userDefaultAddress.fullAddress }}</span>
        收货人：<span>{{ userDefaultAddress.consignee }}</span>
        <span>{{ userAddressList.phoneNum }}</span>
      </div>
    </div>
    <!-- 提交订单 -->
...
export default {
  ...
  computed: {
    ...mapState("trade", ["userTrade", "userAddressList"]),
    userDefaultAddress() {
  ...
  mounted() {
    // 获取用户地址
    this.$store.dispatch("trade/UserAddress");
    // 获取用户订单信息
    this.$store.dispatch("trade/UserTrade");
  },
  methods: {
    changeAddress(address, userAddressList) {
