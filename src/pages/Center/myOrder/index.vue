<template>
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <table class="order-item" v-for="(myOrder) in myOrderList.records" :key="myOrder.index">
          <thead>
            <tr>
              <th colspan="5">
          ...
          <tbody>
            <tr v-for="(good,index) in myOrder.orderDetailList" :key="good.id">
              <td width="60%">
